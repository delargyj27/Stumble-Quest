...
if (isset($_POST['add-crawl'])) {
    ...
    if ($stmt->affected_rows > 0) {
        ...
        // Get the crawl_id (changed to id) of the newly added crawl

        $id = $stmt->insert_id; //changed from $crawl_id to $id 



        // Redirect to crawl.html with crawl_id (changed to id) as a parameter

        header("Location: crawl.html?id={$id}"); //changed from $crawl_id to $id
        ...
        <div class="crawls-section">
            ...
            <div class="existing-crawls-container">
                ...
                <div class="my-crawls-column">
                    ...
                    <!-- Loop through existing crawls and display them in the form (change to id?)-->
