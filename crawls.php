...
if (isset($_POST['invite-crawl'])) {
    ...
    if ($stmt->execute()) {
        ...
        if ($stmt->affected_rows > 0) {
            // Redirect or handle the successful invite
            header("Location: {$_SERVER['PHP_SELF']}?userid={$userid}&success=user_added");
            exit();
        } else {
            // Handle no rows affected or other issues
...
<div class="main-content">
    ...
    <div class="crawls-section">
        ...
        <h2 style="text-align: center; font-family: 'Gloria Hallelujah', cursive; font-size: 30px; background-color: #ffc107; padding: 10px;"><?php echo nl2br($randomQuote); ?></h2>
                            ...
                            <div class="crawl-info">
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    ...
                                    <div class="crawl-datetime">
                                        ...
                                        <div class="info-item">
                                            <select id="status<?php echo $crawl['crawl_id']; ?>" name="status<?php echo $crawl['crawl_id']; ?>">
                                            ...
                                            <select id="visibility<?php echo $crawl['crawl_id']; ?>" name="visibility<?php echo $crawl['crawl_id']; ?>" style="margin-left: 30px;">
                                            ...
                                            <button type="button" onclick="inviteUser(<?php echo $crawl['crawl_id']; ?>)" class="invite-button" style="margin-left: 55px;">Invite</button>
                                        </div>
                                    </div>
                                    ...
                                    <select id="inviteUserDropdown" name="invite_user_id" style="margin-left: 75px;">
